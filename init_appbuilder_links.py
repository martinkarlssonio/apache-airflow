...
# /home/airflow/.local/lib/python3.11/site-packages/airflow/www/extensions/init_appbuilder_links.py
...
def init_appbuilder_links(app):
    ...
    appbuilder.add_link(name="LinkedIn", href="https://www.linkedin.com/in/martin-karlsson/")
    appbuilder.menu.menu.insert(8, appbuilder.menu.menu.pop())  # Place in the seventh menu slot
